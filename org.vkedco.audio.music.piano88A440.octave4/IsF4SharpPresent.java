...
public class IsF4SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "F4#-FA4# Present ";
    static final String DUAL_NAME   = "F4#-FA4#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.F4_SHARP;
    
    public IsF4SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.F4_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.F4_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
