...
public class IsD6Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "D6-RE6 Present ";
    static final String DUAL_NAME   = "D6-RE6";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.D6;
    
    public IsD6Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.D6_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.D6_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
