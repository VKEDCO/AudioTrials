...
public class IsC6Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "C6-DO6 Present ";
    static final String DUAL_NAME   = "C6-DO6";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.C6;
    
    public IsC6Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.C6_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.C6_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
