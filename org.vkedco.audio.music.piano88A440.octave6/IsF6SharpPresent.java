...
public class IsF6SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "F6#-FA6# Present ";
    static final String DUAL_NAME   = "F6#-FA6#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.F6_SHARP;
    
    public IsF6SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.F6_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.F6_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
