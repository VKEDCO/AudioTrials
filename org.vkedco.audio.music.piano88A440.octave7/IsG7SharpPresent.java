...
public class IsG7SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "G7#-SOL7# Present ";
    static final String DUAL_NAME   = "G7#-SOL7#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.G7_SHARP;
    
    public IsG7SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.G7_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.G7_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
