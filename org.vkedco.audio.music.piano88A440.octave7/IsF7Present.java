 ...
 **************************** 
 */
public class IsF7Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "F7-FA7 Present ";
    static final String DUAL_NAME   = "F7-FA7";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.F7;
    
    public IsF7Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.F7_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.F7_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
