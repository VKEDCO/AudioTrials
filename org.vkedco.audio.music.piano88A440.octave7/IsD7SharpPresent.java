...
public class IsD7SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "D7#-RE7# Present ";
    static final String DUAL_NAME   = "D7#-RE7#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.D7_SHARP;
    
    public IsD7SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.D7_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.D7_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
