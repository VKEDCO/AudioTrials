...
public class IsC7SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "C7#-DO7# Present ";
    static final String DUAL_NAME   = "C7#-DO7#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.C7_SHARP;
    
    public IsC7SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.C7_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.C7_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
