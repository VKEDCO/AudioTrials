...
public class IsD1SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "D1#-RE1# Present ";
    static final String DUAL_NAME   = "D1#-RE1#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.D1_SHARP;
    public IsD1SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.D1_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.D1_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
