...
public class IsF1Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "F1-FA1 Present ";
    static final String DUAL_NAME   = "F1-FA1";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.F1;
    public IsF1Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.F1_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.F1_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
