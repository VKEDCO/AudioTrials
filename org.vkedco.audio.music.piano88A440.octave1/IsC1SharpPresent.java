...
public class IsC1SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "D01#-C1# Present ";
    static final String DUAL_NAME   = "DO1#-C1#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.C1_SHARP;
    public IsC1SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.C1_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.C1_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
