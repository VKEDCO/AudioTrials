...
public class IsG1SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "G1#-SOL1# Present ";
    static final String DUAL_NAME   = "G1#-SOL1#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.G1_SHARP;
    public IsG1SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.G1_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.G1_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
