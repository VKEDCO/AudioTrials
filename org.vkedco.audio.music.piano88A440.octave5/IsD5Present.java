 ...
 ****************************
 */
public class IsD5Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "D5-RE5 Present ";
    static final String DUAL_NAME   = "D5-RE5";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.D5;
    
    public IsD5Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.D5_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.D5_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
