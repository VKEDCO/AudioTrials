...
public class IsF5SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "F5#-FA5# Present ";
    static final String DUAL_NAME   = "F5#-FA5#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.F5_SHARP;
    
    public IsF5SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.F5_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.F5_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
