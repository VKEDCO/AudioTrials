 ...
 *****************************
 */
public class IsG5Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE      = "G5-SOL5 Present ";
    static final String DUAL_NAME    = "G5-SOL5";
    static final String LETTER_NAME  = Piano88A440KeysAndFreqs.G5;
    
    public IsG5Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.G5_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.G5_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
