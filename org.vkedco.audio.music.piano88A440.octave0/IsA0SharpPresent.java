...
public class IsA0SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "LA0#-A0# Present ";
    static final String DUAL_NAME   = "LA0#-A0#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.A0_SHARP;
    
    public IsA0SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.A0_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.A0_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
