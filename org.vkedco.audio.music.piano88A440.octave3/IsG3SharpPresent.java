...
public class IsG3SharpPresent extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "G3#-SOL3# Present ";
    static final String DUAL_NAME   = "G3#-SOL3#";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.G3_SHARP;
    
    public IsG3SharpPresent(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.G3_SHARP_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.G3_SHARP_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
