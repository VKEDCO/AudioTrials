...
public class IsF3Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "F3-FA3 Present ";
    static final String DUAL_NAME   = "F3-FA3";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.F3;
    
    public IsF3Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.F3_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.F3_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
