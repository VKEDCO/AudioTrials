...
public class IsD3Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "D3-RE3 Present ";
    static final String DUAL_NAME   = "D3-RE3";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.D3;
    
    public IsD3Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.D3_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.D3_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
