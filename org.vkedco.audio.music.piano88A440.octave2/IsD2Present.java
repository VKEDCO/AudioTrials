...
public class IsD2Present extends FourierAudioFreqEventDetector {
    
    static final String MESSAGE     = "D2-RE2 Present ";
    static final String DUAL_NAME   = "D2-RE2";
    static final String LETTER_NAME = Piano88A440KeysAndFreqs.D2;
    
    public IsD2Present(double xlower, double xupper, double step, double cthresh, double athresh, double error_margin) {
        super((int)(Piano88A440KeysAndFreqs.D2_FREQ - Piano88A440NoteFrequencyRanges.BAND), 
              (int)(Piano88A440KeysAndFreqs.D2_FREQ + Piano88A440NoteFrequencyRanges.BAND), 
